...
Add the google-java-format plugin or download the IntelliJ Java Google Style Guide from https://github.com/google/styleguide, unzip it, then import it into IntelliJ through File -> Settings -> Code Style -> Scheme:
...
There are Markdown and Markdown Navigator plugins for IntelliJ
